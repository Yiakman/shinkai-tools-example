...
const textSearch = async (keywords: string): Promise<SearchResult[]> => {
...
export const duckduckgoSearch = async (keywords: string): Promise<Result> => {
  return await run({}, { message: keywords });
};
